    ...
    <Layout>
      ...
      >
        ...
        <Text style="body1" css={{ mb: 48 }}>
          Unick NFT Marketplace is a multi-chain Aggregator<br />
          Providing liquidity and data from largest marketplaces in the world <br />
          Connect your wallet to interact with our dApp
        </Text>
        <ConnectWalletButton />
      </Flex>
        )}
